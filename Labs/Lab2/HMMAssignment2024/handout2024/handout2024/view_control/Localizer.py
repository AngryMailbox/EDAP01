...
from models import ObservationModel_UF as ObservationModelUF
from models import ObservationModel_NUF as ObservationModelNUF
...
class Localizer:
    def __init__(self, sm, uniformF):
        ...
        self.__tm = TransitionModel.TransitionModel(self.__sm)
        if uniformF == 1:
            self.__om = ObservationModelUF.ObservationModelUF(self.__sm)
        else:
            self.__om = ObservationModelNUF.ObservationModelNUF(self.__sm)
    ...
    def initialise(self):
        ...
        self.__rs = RobotSim.RobotSim(self.__trueState, self.__sm)
    ...
    def update(self) -> (bool, int, int, int, int, int, int, int, int, np.array(1)):
        ...
        self.__probs = self.__HMM.fwd_filter(self.__sense)
    ...
    def updateWTruePose(
        self, trueState
    ) -> (bool, int, int, int, int, int, int, int, int, np.array(1)):
